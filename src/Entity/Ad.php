...
class Ad
{
     ...
     * @Assert\Length(min=10, max=255, minMessage="Le titre doit faire plus de 10 caractères", maxMessage="Le titre est trop long")
     */
    private $title;
     ...
     * @Assert\Length(min=20, minMessage="Votre intro doit etre sup à 20 caractères")
     */
    ...
    /**
     * Permet d'obtenir un tableau des jours qui ne sont pas disponibles pour cette annonnce
     * 
